...
Calculation for `01-12-2024`: `(42 - 33) * 1.150` = `10.35`, **rounded** to 0 decimals to `10`. Then, `10 * 55%` = `5.5`, **casted** to 0 decimals to `5`, but kept in the backed rounded to 0 decimals, which then will `5.5` = `6`. 
Calculation for `02-12-2024`: `BeginValue` of previous day + rounded value of previous day = `33 + 6` = `39`.
